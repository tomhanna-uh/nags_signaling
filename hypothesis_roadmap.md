...
| **H6** | NAG Support Count  | sidea_revisionist_domestic * nags_targets_democracy | Logistic | logit(Pr(DemTarget)) = β₀ + β₁·Revisionist + controls | Same as H1 | fixest | `feglm(nags_targets_democracy ~ revisionist_high + ...)` | — | Democracy targeting. |
