...
| **H6** | NAG Support to NAGS with Democracy Target (binary) | sidea_revisionist_domestic | Logistic | logit(Pr(DemTarget)) = β₀ + β₁·Revisionist + controls | Same as H1 | fixest | `feglm(nags_targets_democracy ~ revisionist_high + ...)` | — | Democracy targeting. |
